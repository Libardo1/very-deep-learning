...
python alexnet_train.py --train_dir=model_small --activation=relu --learning_rate=0.001 --steps_per_checkpoint=1000 --model=5 --data_dir=data/ --eval_dir=results/ --eval --num_examples=10000
