...
python alexnet_train.py --train_dir=model_1_relu --activation=relu --learning_rate=0.001 --steps_per_checkpoint=1000 --model=1 --data_dir=data/
...
python alexnet_train.py --train_dir=model_1_sigmoid --activation=sigmoid --learning_rate=0.001 --steps_per_checkpoint=1000 --model=1 --data_dir=data/
...
python alexnet_train.py --train_dir=model_1_tanh --activation=tanh --learning_rate=0.001 --steps_per_checkpoint=1000 --model=1 --data_dir=data/
...
python alexnet_train.py --train_dir=model_2 --activation=relu --learning_rate=0.001 --steps_per_checkpoint=1000 --model=2 --data_dir=data/
...
python alexnet_train.py --train_dir=model_3 --activation=relu --learning_rate=0.001 --steps_per_checkpoint=1000 --model=3 --data_dir=data/
...
python alexnet_train.py --train_dir=model_4 --activation=relu --learning_rate=0.001 --steps_per_checkpoint=1000 --model=4 --data_dir=data/
...
python alexnet_train.py --train_dir=model_small --activation=relu --learning_rate=0.001 --steps_per_checkpoint=1000 --model=5 --data_dir=data/
